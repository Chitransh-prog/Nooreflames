    ...
    <div className="page-wrapper">
      ...
      <section className="about-hero-section" style={{
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 'clamp(14px, 2vw, 18px)', color: '#b0d4cf', lineHeight: 1.6, fontWeight: 300 }}>
      ...
      <section style={{ padding: 'clamp(40px, 6vw, 80px) 20px', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{
          ...
          <div>
            ...
            <p style={{ color: '#555555', fontSize: '15px', lineHeight: 1.7, marginBottom: '18px' }}>
          ...
          <div style={{
            ...
            <h3 className="font-serif" style={{ fontSize: 'clamp(22px, 3vw, 28px)', color: '#1b3d39', marginBottom: '16px' }}>
              Our Promise to You
            </h3>
