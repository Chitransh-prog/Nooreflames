  ...
  return (
    <div className="page-wrapper">
      ...
      <section className="about-hero-section" style={{
        background: 'linear-gradient(135deg, #1b3d39 0%, #244b46 100%)',
        color: '#ffffff',
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <h1 className="font-serif" style={{ fontSize: '52px', lineHeight: 1.15, marginBottom: '24px' }}>
            Where Fragrance Meets Flames
          </h1>
          <p style={{ fontSize: '18px', color: '#b0d4cf', lineHeight: 1.6, fontWeight: 300 }}>
      ...
      <section style={{ padding: '80px 24px', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{
          ...
          <div>
            <span style={{ fontSize: '11px', letterSpacing: '0.2em', color: '#c9935a', fontWeight: 700, textTransform: 'uppercase', display: 'block', marginBottom: '8px' }}>
              THE ART OF PERFUMERY
            </span>
            <h2 className="font-serif" style={{ fontSize: '38px', color: '#121212', marginBottom: '20px', lineHeight: 1.2 }}>
              Crafted at Extrait Concentration for Unrivaled Longevity
            </h2>
            <p style={{ color: '#555555', fontSize: '16px', lineHeight: 1.7, marginBottom: '18px' }}>
          ...
          <div style={{
            ...
            <h3 className="font-serif" style={{ fontSize: '28px', color: '#1b3d39', marginBottom: '16px' }}>
              Our Promise to You
            </h3>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '14px', color: '#333333', fontSize: '15px' }}>
              <li style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <span style={{ color: '#c9935a' }}>✦</span> 100% Cruelty-Free & Vegan Ingredients
              </li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <span style={{ color: '#c9935a' }}>✦</span> Alcohol-Free Attars Gentle on Sensitive Skin
              </li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <span style={{ color: '#c9935a' }}>✦</span> Hand-Poured Soy Wax with Zero Toxins or Paraffin
              </li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <span style={{ color: '#c9935a' }}>✦</span> Sustainable Luxury Packaging & Heavy Flacons
              </li>
            </ul>
          </div>
        </div>
